...
public class SplatCycler : MonoBehaviour
{
    ...
    VRRig _rig;
    CameraTrajectoryPlayer _trajectoryPlayer;
    ...
    void Start()
    {
        ...
        _trajectoryPlayer = CameraTrajectoryPlayer.FindOrCreate();

        ApplyPreloadBudget();

        if (string.IsNullOrEmpty(splatFolder))
            splatFolder = ResolveDefaultSplatFolder();
    ...
    public void LoadIndex(int index)
    {
        ...
        if (loader.LoadFile(path))
        {
            ...
            if (_trajectoryPlayer == null)
                _trajectoryPlayer = CameraTrajectoryPlayer.FindOrCreate();
            if (_trajectoryPlayer != null)
                _trajectoryPlayer.TryLoadMatchingTrajectoryForSplat(path, true);
        }
    }
    ...
    static string ResolveDefaultSplatFolder()
    {
